...
namespace App\Http\ViewComposers\Dashboard;
...
class OverviewComposer
{
    ...
    /**
     * The authenticated users balance.
     *
     * @var int
     */
    private $balance;
    ...
    {
        // records...
        $disbursements = $this->user->disbursements()->latest()->take(2)->get();
        ...
        $current = $this->user->earnings; // $disbursements->first()->amount;
